...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,email,displayName,photoUrl,role,tenantId,fcmToken,phoneNumber,cpf,isWhatsApp,status,subscriptionStatus,subscriptionUpdatedAt,address,ndaAcceptedVersion,ndaAcceptedAt,lastAccessAt,strikeUntil,lastStrikeReason]);
...
@useResult
$Res call({
 String uid, String email, String? displayName, String? photoUrl, String role, String? tenantId, String? fcmToken, String? phoneNumber, String? cpf, bool isWhatsApp, String status, String subscriptionStatus,@TimestampConverter() DateTime? subscriptionUpdatedAt, Address? address, String? ndaAcceptedVersion,@TimestampConverter() DateTime? ndaAcceptedAt,@TimestampConverter() DateTime? lastAccessAt,@TimestampConverter() DateTime? strikeUntil, String? lastStrikeReason
});
