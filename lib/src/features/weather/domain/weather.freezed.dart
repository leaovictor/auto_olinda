...
mixin _$Weather {
 ...
 double get temperature; int get relativeHumidity; bool get isDay; double get precipitation; int get weatherCode; List<DailyWeather> get dailyForecast;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Weather&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.relativeHumidity, relativeHumidity) || other.relativeHumidity == relativeHumidity)&&(identical(other.isDay, isDay) || other.isDay == isDay)&&(identical(other.precipitation, precipitation) || other.precipitation == precipitation)&&(identical(other.weatherCode, weatherCode) || other.weatherCode == weatherCode)&&const DeepCollectionEquality().equals(other.dailyForecast, dailyForecast));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,temperature,relativeHumidity,isDay,precipitation,weatherCode,const DeepCollectionEquality().hash(dailyForecast));

@override
String toString() {
  return 'Weather(temperature: $temperature, relativeHumidity: $relativeHumidity, isDay: $isDay, precipitation: $precipitation, weatherCode: $weatherCode, dailyForecast: $dailyForecast)';
}
...
@useResult
$Res call({
 double temperature, int relativeHumidity, bool isDay, double precipitation, int weatherCode, List<DailyWeather> dailyForecast
});
...
/// Create a copy of Weather
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? temperature = null,Object? relativeHumidity = null,Object? isDay = null,Object? precipitation = null,Object? weatherCode = null,Object? dailyForecast = null,}) {
...
as int,dailyForecast: null == dailyForecast ? _self.dailyForecast : dailyForecast // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double temperature,  int relativeHumidity,  bool isDay,  double precipitation,  int weatherCode,  List<DailyWeather> dailyForecast)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Weather() when $default != null:
return $default(_that.temperature,_that.relativeHumidity,_that.isDay,_that.precipitation,_that.weatherCode,_that.dailyForecast);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double temperature,  int relativeHumidity,  bool isDay,  double precipitation,  int weatherCode,  List<DailyWeather> dailyForecast)  $default,) {final _that = this;
switch (_that) {
case _Weather():
return $default(_that.temperature,_that.relativeHumidity,_that.isDay,_that.precipitation,_that.weatherCode,_that.dailyForecast);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double temperature,  int relativeHumidity,  bool isDay,  double precipitation,  int weatherCode,  List<DailyWeather> dailyForecast)?  $default,) {final _that = this;
switch (_that) {
case _Weather() when $default != null:
return $default(_that.temperature,_that.relativeHumidity,_that.isDay,_that.precipitation,_that.weatherCode,_that.dailyForecast);case _:
  return null;
...
class _Weather implements Weather {
  const _Weather({required this.temperature, required this.relativeHumidity, required this.isDay, required this.precipitation, required this.weatherCode, final  List<DailyWeather> dailyForecast = const []}): _dailyForecast = dailyForecast;
...
@override final  int weatherCode;
 final  List<DailyWeather> _dailyForecast;
@override@JsonKey() List<DailyWeather> get dailyForecast {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Weather&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.relativeHumidity, relativeHumidity) || other.relativeHumidity == relativeHumidity)&&(identical(other.isDay, isDay) || other.isDay == isDay)&&(identical(other.precipitation, precipitation) || other.precipitation == precipitation)&&(identical(other.weatherCode, weatherCode) || other.weatherCode == weatherCode)&&const DeepCollectionEquality().equals(other._dailyForecast, _dailyForecast));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,temperature,relativeHumidity,isDay,precipitation,weatherCode,const DeepCollectionEquality().hash(_dailyForecast));
...
/// Create a copy of Weather
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? temperature = null,Object? relativeHumidity = null,Object? isDay = null,Object? precipitation = null,Object? weatherCode = null,Object? dailyForecast = null,}) {
...
as bool,precipitation: null == precipitation ? _self.precipitation : precipitation // ignore: cast_nullable_to_non_nullable
as double,weatherCode: null == weatherCode ? _self.weatherCode : weatherCode // ignore: cast_nullable_to_non_nullable
as int,dailyForecast: null == dailyForecast ? _self._dailyForecast : dailyForecast // ignore: cast_nullable_to_non_nullable
as List<DailyWeather>,
  ));
}
...
mixin _$DailyWeather {
 ...
 DateTime get date; double get maxTemp; double get minTemp; int get precipitationProbability; int get weatherCode;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,date,maxTemp,minTemp,precipitationProbability,weatherCode);

@override
String toString() {
  return 'DailyWeather(date: $date, maxTemp: $maxTemp, minTemp: $minTemp, precipitationProbability: $precipitationProbability, weatherCode: $weatherCode)';
}
...
@useResult
$Res call({
 DateTime date, double maxTemp, double minTemp, int precipitationProbability, int weatherCode
});
...
/// Create a copy of DailyWeather
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? date = null,Object? maxTemp = null,Object? minTemp = null,Object? precipitationProbability = null,Object? weatherCode = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime date,  double maxTemp,  double minTemp,  int precipitationProbability,  int weatherCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DailyWeather() when $default != null:
return $default(_that.date,_that.maxTemp,_that.minTemp,_that.precipitationProbability,_that.weatherCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime date,  double maxTemp,  double minTemp,  int precipitationProbability,  int weatherCode)  $default,) {final _that = this;
switch (_that) {
case _DailyWeather():
return $default(_that.date,_that.maxTemp,_that.minTemp,_that.precipitationProbability,_that.weatherCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime date,  double maxTemp,  double minTemp,  int precipitationProbability,  int weatherCode)?  $default,) {final _that = this;
switch (_that) {
case _DailyWeather() when $default != null:
return $default(_that.date,_that.maxTemp,_that.minTemp,_that.precipitationProbability,_that.weatherCode);case _:
  return null;
...
class _DailyWeather implements DailyWeather {
  const _DailyWeather({required this.date, required this.maxTemp, required this.minTemp, required this.precipitationProbability, required this.weatherCode});
...
/// Create a copy of DailyWeather
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? maxTemp = null,Object? minTemp = null,Object? precipitationProbability = null,Object? weatherCode = null,}) {
