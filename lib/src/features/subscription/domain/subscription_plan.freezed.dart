...
mixin _$SubscriptionPlan {
 ...
 String get id; String get name; double get price; List<String> get features; String get tenantId; String get stripePriceId; String get category;// hatch, suv, moto, any
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,const DeepCollectionEquality().hash(features),tenantId,stripePriceId,category,washesPerMonth,isActive);

@override
String toString() {
  return 'SubscriptionPlan(id: $id, name: $name, price: $price, features: $features, tenantId: $tenantId, stripePriceId: $stripePriceId, category: $category, washesPerMonth: $washesPerMonth, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String name, double price, List<String> features, String tenantId, String stripePriceId, String category, int washesPerMonth, bool isActive
});
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? price = null,Object? features = null,Object? tenantId = null,Object? stripePriceId = null,Object? category = null,Object? washesPerMonth = null,Object? isActive = null,}) {
...
as List<String>,tenantId: null == tenantId ? _self.tenantId : tenantId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double price,  List<String> features,  String tenantId,  String stripePriceId,  String category,  int washesPerMonth,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.features,_that.tenantId,_that.stripePriceId,_that.category,_that.washesPerMonth,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  double price,  List<String> features,  String tenantId,  String stripePriceId,  String category,  int washesPerMonth,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan():
return $default(_that.id,_that.name,_that.price,_that.features,_that.tenantId,_that.stripePriceId,_that.category,_that.washesPerMonth,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  double price,  List<String> features,  String tenantId,  String stripePriceId,  String category,  int washesPerMonth,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _SubscriptionPlan() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.features,_that.tenantId,_that.stripePriceId,_that.category,_that.washesPerMonth,_that.isActive);case _:
  return null;
...
class _SubscriptionPlan implements SubscriptionPlan {
  const _SubscriptionPlan({required this.id, required this.name, required this.price, required final  List<String> features, required this.tenantId, this.stripePriceId = '', this.category = 'any', this.washesPerMonth = 4, this.isActive = true}): _features = features;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,const DeepCollectionEquality().hash(_features),tenantId,stripePriceId,category,washesPerMonth,isActive);
...
/// Create a copy of SubscriptionPlan
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? price = null,Object? features = null,Object? tenantId = null,Object? stripePriceId = null,Object? category = null,Object? washesPerMonth = null,Object? isActive = null,}) {
