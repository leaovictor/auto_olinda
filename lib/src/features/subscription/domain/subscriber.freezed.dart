...
mixin _$Subscriber {
 ...
 String? get stripeSubscriptionId; int get bonusWashes; String? get companyId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,planId,startDate,endDate,cancelAtPeriodEnd,status,stripeSubscriptionId,bonusWashes,companyId);

@override
String toString() {
  return 'Subscriber(id: $id, userId: $userId, planId: $planId, startDate: $startDate, endDate: $endDate, cancelAtPeriodEnd: $cancelAtPeriodEnd, status: $status, stripeSubscriptionId: $stripeSubscriptionId, bonusWashes: $bonusWashes, companyId: $companyId)';
}
...
@useResult
$Res call({
 String id, String userId, String planId,@TimestampConverter() DateTime startDate,@TimestampConverter() DateTime? endDate, bool cancelAtPeriodEnd, String status, String? stripeSubscriptionId, int bonusWashes, String? companyId
});
...
/// Create a copy of Subscriber
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? planId = null,Object? startDate = null,Object? endDate = freezed,Object? cancelAtPeriodEnd = null,Object? status = null,Object? stripeSubscriptionId = freezed,Object? bonusWashes = null,Object? companyId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  String? stripeSubscriptionId,  int bonusWashes,  String? companyId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subscriber() when $default != null:
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.stripeSubscriptionId,_that.bonusWashes,_that.companyId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  String? stripeSubscriptionId,  int bonusWashes,  String? companyId)  $default,) {final _that = this;
switch (_that) {
case _Subscriber():
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.stripeSubscriptionId,_that.bonusWashes,_that.companyId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  String? stripeSubscriptionId,  int bonusWashes,  String? companyId)?  $default,) {final _that = this;
switch (_that) {
case _Subscriber() when $default != null:
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.stripeSubscriptionId,_that.bonusWashes,_that.companyId);case _:
  return null;
...
class _Subscriber extends Subscriber {
  const _Subscriber({required this.id, required this.userId, required this.planId, @TimestampConverter() required this.startDate, @TimestampConverter() this.endDate, this.cancelAtPeriodEnd = false, required this.status, this.stripeSubscriptionId, this.bonusWashes = 0, this.companyId}): super._();
...
/// Create a copy of Subscriber
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? planId = null,Object? startDate = null,Object? endDate = freezed,Object? cancelAtPeriodEnd = null,Object? status = null,Object? stripeSubscriptionId = freezed,Object? bonusWashes = null,Object? companyId = freezed,}) {
