...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,planId,startDate,endDate,cancelAtPeriodEnd,status,bonusWashes);

@override
String toString() {
  return 'Subscriber(id: $id, userId: $userId, planId: $planId, startDate: $startDate, endDate: $endDate, cancelAtPeriodEnd: $cancelAtPeriodEnd, status: $status, bonusWashes: $bonusWashes)';
}
...
@useResult
$Res call({
 String id, String userId, String planId,@TimestampConverter() DateTime startDate,@TimestampConverter() DateTime? endDate, bool cancelAtPeriodEnd, String status, int bonusWashes
});
...
/// Create a copy of Subscriber
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? planId = null,Object? startDate = null,Object? endDate = freezed,Object? cancelAtPeriodEnd = null,Object? status = null,Object? bonusWashes = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  int bonusWashes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subscriber() when $default != null:
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.bonusWashes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  int bonusWashes)  $default,) {final _that = this;
switch (_that) {
case _Subscriber():
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.bonusWashes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String planId, @TimestampConverter()  DateTime startDate, @TimestampConverter()  DateTime? endDate,  bool cancelAtPeriodEnd,  String status,  int bonusWashes)?  $default,) {final _that = this;
switch (_that) {
case _Subscriber() when $default != null:
return $default(_that.id,_that.userId,_that.planId,_that.startDate,_that.endDate,_that.cancelAtPeriodEnd,_that.status,_that.bonusWashes);case _:
  return null;
...
class _Subscriber extends Subscriber {
  const _Subscriber({required this.id, required this.userId, required this.planId, @TimestampConverter() required this.startDate, @TimestampConverter() this.endDate, this.cancelAtPeriodEnd = false, required this.status, this.bonusWashes = 0}): super._();
...
/// Create a copy of Subscriber
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? planId = null,Object? startDate = null,Object? endDate = freezed,Object? cancelAtPeriodEnd = null,Object? status = null,Object? bonusWashes = null,}) {
