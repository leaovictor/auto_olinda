...
mixin _$NewBookingNotificationData {
 ...
 String? get clientName; String? get clientPhone; String? get clientPhotoUrl;// Vehicle info (for car wash or aesthetic that requires vehicle)
...
@override
int get hashCode => Object.hash(runtimeType,bookingId,type,scheduledTime,totalPrice,createdAt,clientName,clientPhone,clientPhotoUrl,vehiclePlate,vehicleModel,vehicleBrand,serviceName,const DeepCollectionEquality().hash(serviceNames));

@override
String toString() {
  return 'NewBookingNotificationData(bookingId: $bookingId, type: $type, scheduledTime: $scheduledTime, totalPrice: $totalPrice, createdAt: $createdAt, clientName: $clientName, clientPhone: $clientPhone, clientPhotoUrl: $clientPhotoUrl, vehiclePlate: $vehiclePlate, vehicleModel: $vehicleModel, vehicleBrand: $vehicleBrand, serviceName: $serviceName, serviceNames: $serviceNames)';
}
...
@useResult
$Res call({
 String bookingId, NewBookingType type, DateTime scheduledTime, double totalPrice, DateTime createdAt, String? clientName, String? clientPhone, String? clientPhotoUrl, String? vehiclePlate, String? vehicleModel, String? vehicleBrand, String? serviceName, List<String> serviceNames
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String bookingId,  NewBookingType type,  DateTime scheduledTime,  double totalPrice,  DateTime createdAt,  String? clientName,  String? clientPhone,  String? clientPhotoUrl,  String? vehiclePlate,  String? vehicleModel,  String? vehicleBrand,  String? serviceName,  List<String> serviceNames)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewBookingNotificationData() when $default != null:
return $default(_that.bookingId,_that.type,_that.scheduledTime,_that.totalPrice,_that.createdAt,_that.clientName,_that.clientPhone,_that.clientPhotoUrl,_that.vehiclePlate,_that.vehicleModel,_that.vehicleBrand,_that.serviceName,_that.serviceNames);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,bookingId,type,scheduledTime,totalPrice,createdAt,clientName,clientPhone,clientPhotoUrl,vehiclePlate,vehicleModel,vehicleBrand,serviceName,const DeepCollectionEquality().hash(_serviceNames));
