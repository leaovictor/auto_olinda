...
exports.seedDatabase = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "Failed to seed database.");
    }
});
/**
...
async function seedPlans(db) {
    ...
    for (const plan of plans) {
        ...
        batch.set(docRef, Object.assign(Object.assign({}, plan), { createdAt: admin.firestore.FieldValue.serverTimestamp() }));
    }
    await batch.commit();
