...
exports.updateSubscriptionVehicle = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        const lastChange = subData === null || subData === void 0 ? void 0 : subData.lastPlateChange;
        const currentVehicleId = subData === null || subData === void 0 ? void 0 : subData.vehicleId;
