...
async function main() {
    ...
    if (!tenantSnap.exists) {
        console.error(`❌  Tenant document /tenants/${TENANT_ID} does not exist.\n` +
    ...
    do {
        ...
        for (const user of listResult.users) {
            ...
            const alreadyHasTenant = claims === null || claims === void 0 ? void 0 : claims.tenantId;
            if (!alreadyHasTenant) {
                // Set claims — preserve existing role if any
                const existingRole = (_a = claims === null || claims === void 0 ? void 0 : claims.role) !== null && _a !== void 0 ? _a : 'customer';
                batch.push(auth.setCustomUserClaims(user.uid, Object.assign(Object.assign({}, claims), { tenantId: TENANT_ID, role: existingRole })));
            }
    ...
    for (const colName of COLLECTIONS_TO_MIGRATE) {
        ...
        for (const chunk of chunks) {
            ...
            for (const doc of chunk) {
                ...
                writeBatch.set(destRef, Object.assign(Object.assign({}, doc.data()), { tenantId: TENANT_ID, _migratedAt: admin.firestore.FieldValue.serverTimestamp() }));
                migrated++;
            }
...
//# sourceMappingURL=seed_auto_olinda.js.map