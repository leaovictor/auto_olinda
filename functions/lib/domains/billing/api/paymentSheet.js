...
exports.createPaymentSheet = void 0;
 ...
 */
exports.createPaymentSheet = (0, https_1.onCall)({ secrets: [env_1.stripeSecret, env_1.stripePublishableKey], cors: true }, async (request) => {
    var _a, _b;
    if (!request.auth) {
            ...
            if (typeof paymentIntent === "string") {
                ...
                if (pi.client_secret) {
                    return {
                        ...
                        customer: customerId,
                        publishableKey: await (0, stripe_1.getStripePublishableKey)(),
