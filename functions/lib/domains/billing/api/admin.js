...
exports.getPublicStripeConfig = exports.createStripeCoupon = exports.syncServiceWithStripe = exports.syncPlanWithStripe = exports.adminCreateSubscription = exports.adminGrantPremiumDays = exports.adminAdjustBonusWashes = exports.getStripeTransactions = exports.getStripeSubscriptions = exports.adminResumeSubscription = exports.adminCancelSubscription = exports.adminPauseSubscription = void 0;
 ...
 */
exports.adminPauseSubscription = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
 ...
 */
exports.adminCancelSubscription = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
 ...
 */
exports.adminResumeSubscription = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
    const { userId } = request.data;
 ...
 */
exports.getStripeSubscriptions = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
 ...
 */
exports.getStripeTransactions = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
...
exports.adminGrantPremiumDays = (0, https_1.onCall)({ cors: true }, async (request) => {
    ...
    try {
        ...
        if (!subsQuery.empty) {
            const subDoc = subsQuery.docs[0];
            const currentEndDate = ((_b = (_a = subDoc.data().endDate) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a)) || now;
 ...
 */
exports.adminCreateSubscription = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    var _a, _b, _c;
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
    ...
    try {
        ...
        if (couponId) {
            const couponDoc = await admin.firestore()
                ...
                .get();
            if (!couponDoc.exists)
                throw new https_1.HttpsError("not-found", `Coupon ${couponId} not found.`);
 ...
 */
exports.syncPlanWithStripe = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    var _a, _b;
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    ...
    try {
        ...
        const description = (features === null || features === void 0 ? void 0 : features.length) > 0 ? features.join(", ") : `Plano ${name}`;
        if (productId) {
            try {
 ...
 */
exports.syncServiceWithStripe = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    var _a, _b;
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
 ...
 */
exports.createStripeCoupon = (0, https_1.onCall)({ secrets: [env_1.stripeSecret], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    await requireAdmin(request.auth.uid);
 ...
 */
exports.getPublicStripeConfig = (0, https_1.onCall)({ secrets: [env_1.stripePublishableKey], cors: true }, async (request) => {
    if (!request.auth)
        throw new https_1.HttpsError("unauthenticated", "Must be authenticated.");
    try {
        const settings = await (0, stripe_1.getPaymentSettings)();
        const publishableKey = (settings === null || settings === void 0 ? void 0 : settings.stripe_publishable_key) || env_1.stripePublishableKey.value();
        if (!publishableKey) {
